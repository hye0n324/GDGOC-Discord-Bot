...
│   └── fortuneSync.js   # /포춘쿠키동기화 (/fortune_sync) 수동 동기화 명령어
├── utils/               # 유틸리티 및 데이터 처리 로직
│   └── fortuneData.js   # 구글 시트 연동 및 포춘쿠키 데이터 추첨 로직
├── .env                 # 환경 변수 (토큰 및 구글 시트 설정 - Git 제외)
...
부원들에게 매일 소소한 즐거움과 소확행을 제공하는 슬래시 명령어입니다.
...
서버 관리자가 구글 시트 내용을 새로 편집한 후 즉시 봇에 반영할 수 있는 수동 동기화 명령어입니다.
